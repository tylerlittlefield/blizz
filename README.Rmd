...
After this, you're all set. If you want to avoid using `blizz_cred()`, you can do all of this yourself by following the [docs](https://develop.battle.net/documentation/guides/getting-started).
